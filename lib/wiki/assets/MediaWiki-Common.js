...
$(function () {
  ...
  var tools_url = "https://accessifywiki--1.appspot.com/",
    iframe_re = "[^\\/]+.ac.uk|accessifywiki(--\\d)?.appspot.com"
      + "|docs.google.com|www.youtube.com|www.slideshare.net",
    editor = true;  //Crashing Chrome? 30 July.
...
*/
  ...
  function setup_iframes() {
    ...
    $("a[href *= 'EMBED_ME']").each(function (i, el) {
      ...
      if (! url.match(new RegExp("^https?:\\/\\/(" + iframe_re + ")\\/"))) {
        return;
      }
