...
$(function () {
  ...
  AcfyWiki.tools_url = AcfyWiki.local ? "http://localhost:8081/"
      : "https://accessifywiki--1.appspot.com/";

  AcfyWiki.addScript = function (src) {
    var s = D.createElement("script");
    s.src = src.match("://") ? src : AcfyWiki.tools_url + src;
    s.charset = "utf-8";
  ...
  AcfyWiki.addScript("site/setup/config.js");
