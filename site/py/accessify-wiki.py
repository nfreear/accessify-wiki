 ...
 * What is Accessify Wiki? Accessify Wiki is a way of authoring accessibility fixes for a site, without having control of that site, then delivering the fixes to a user during their normal browsing experience. It is not
...
### How are fixes used? Lifecycle

It is envisioned that accessibility fixes will be used in three ways -- a typical lifecycle might be:
...
page = markdown.markdown(markdown_page + my.markdownReferences())
